...
class StatisticalClassifierServiceContainer extends Container
{
    ...
    {
        return $this->services['classifier.naive_bayes'] = new \Camspiers\StatisticalClassifier\Classifier\NaiveBayes($this->get('data_source.data_source'), $this->get('index.cached_index'), $this->get('tokenizer.word'), $this->get('normalizer.stopword'));
    }
